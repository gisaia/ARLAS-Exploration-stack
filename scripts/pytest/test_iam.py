...
from variables import ANONYMOUS, COLLECTION1_ORG_1_PRIVATE, COLLECTION1_ORG_1_PUBLIC, INDEX_ORG1, INDEX_ORG2, ORG_1, ORPHAN, ORPHAN_ORG_FILTER_ARLAS_ORG1, ORPHAN_ORG_FILTER_ORG1, ORPHAN_ORG_FILTER_ORG1_ARLAS_ORG1, ORPHAN_ORG_FILTER_ORG2, OWNER_ORG_1, OWNER_ORG_2, PERMISSION, USER_ORG_1, USER_ORG_2_NO_ORG_FILTER, USER_ORG_2, USER_TO_UID
...
def test_admin_create_org(cli_confs, fixture_init):
...
def test_user_not_create_org_on_forbidden_user_domain(cli_confs, fixture_init):
    email, id = create_user(USER_ADMIN, USER_ORG_1)
...
def test_users_can_see_orgs(run_as, cli_confs, fixture_init, fixture_org1_owner_and_user):
...
def test_admin_delete_org(cli_confs, fixture_init, fixture_org1_owner_and_user):
    oid, __, __, __ = fixture_org1_owner_and_user
...
# Test add users
def test_add_user_to_org_as_admin(cli_confs, fixture_init, fixture_org1_owner):
...
def test_add_user_to_org_as_owner(cli_confs, fixture_init, fixture_org1_owner):
...
def test_not_add_user_to_org_as_not_owner(run_as, cli_confs, fixture_init, fixture_org1_owner_and_user, fixture_org2_owner_and_users, fixture_orphans):
...
@pytest.mark.parametrize("run_as", CAN_NOT_SEE_ORG1)
def test_foreigners_do_not_see_other_org_users(run_as, cli_confs, fixture_init, fixture_org1_owner_and_user, fixture_org2_owner_and_users, fixture_orphans, fixture_collections):
...
def test_users_can_see_user_from_org(cli_confs, fixture_init, fixture_org1_owner_and_user, fixture_org2_owner_and_users, fixture_orphans, fixture_collections):
...
def test_foreigners_do_not_see_private_collection(run_as, cli_confs, fixture_init, fixture_org1_owner_and_user, fixture_org2_owner_and_users, fixture_orphans, fixture_collections):
...
def test_users_can_see_collection(run_as, collection, cli_confs, fixture_init, fixture_org1_owner_and_user, fixture_org2_owner_and_users, fixture_orphans, fixture_collections):
...
def test_users_can_see_collection_iam(run_as, collection, cli_confs, fixture_init, fixture_org1_owner_and_user, fixture_org2_owner_and_users, fixture_orphans, fixture_collections):
    ...
    oid, email1, email2, groups = fixture_org1_owner_and_user
    assert see_collection_iam(run_as, oid, COLLECTION1_ORG_1_PRIVATE) is True


# Test collection describe visibility

@pytest.mark.parametrize("run_as", CAN_NOT_SEE_FOREIGN_PRIVE_COLLECTIONS)
def test_foreigners_do_not_see_private_collection_description(run_as, cli_confs, fixture_init, fixture_org1_owner_and_user, fixture_org2_owner_and_users, fixture_orphans, fixture_collections):
...
@pytest.mark.parametrize("run_as, collection", CAN_SEE_COLLECTIONS)
def test_users_can_see_collection_description(run_as, collection, cli_confs, fixture_init, fixture_org1_owner_and_user, fixture_org2_owner_and_users, fixture_orphans, fixture_collections):
...
@pytest.mark.parametrize("run_as", CAN_NOT_SEE_FOREIGN_PRIVE_COLLECTIONS)
def test_foreigners_do_not_see_private_collection_sample(run_as, cli_confs, fixture_init, fixture_org1_owner_and_user, fixture_org2_owner_and_users, fixture_orphans, fixture_collections):
...
@pytest.mark.parametrize("run_as, collection", CAN_SEE_COLLECTIONS)
def test_users_can_see_collection_sample(run_as, collection, cli_confs, fixture_init, fixture_org1_owner_and_user, fixture_org2_owner_and_users, fixture_orphans, fixture_collections):
...
def test_owner_can_create_collection(cli_confs, fixture_init, fixture_org1_owner):
...
def test_can_not_create_collection(run_as, cli_confs, fixture_init, fixture_org1_owner_and_user, fixture_org2_owner_and_users, fixture_orphans):
...
def test_owner_can_not_create_collection_with_wrong_index_prefix(cli_confs, fixture_init, fixture_org1_owner):
...
def test_owner_can_delete_collection(cli_confs, fixture_init, fixture_org1_owner, fixture_org2_owner, fixture_collections):
    """Test: as owner, I can create a collection"""
    Service.delete_collection(arlas=OWNER_ORG_1, collection=COLLECTION1_ORG_1_PRIVATE)


@pytest.mark.parametrize("run_as", CAN_NOT_CREATE_DELETE_OR_UPDATE) 
def test_can_not_delete_collection(run_as, cli_confs, fixture_init, fixture_org1_owner_and_user, fixture_org2_owner_and_users, fixture_orphans, fixture_collections):
...
def test_owner_can_update_collection(cli_confs, fixture_init, fixture_org1_owner, fixture_org2_owner, fixture_collections):
...
@pytest.mark.parametrize("run_as", CAN_NOT_CREATE_DELETE_OR_UPDATE)
def test_can_not_update_collection(run_as, cli_confs, fixture_init, fixture_org1_owner_and_user, fixture_org2_owner_and_users, fixture_orphans, fixture_collections):
...
def test_owner_can_create_and_delete_group_and_permission(cli_confs, fixture_init, fixture_org1_owner_and_user):
...
@pytest.mark.parametrize("run_as", CAN_NOT_CREATE_DELETE_OR_UPDATE)
def test_can_not_create_permission(run_as, cli_confs, fixture_init, fixture_org1_owner_and_user, fixture_org2_owner_and_users, fixture_orphans):
...
@pytest.mark.parametrize("run_as", CAN_NOT_CREATE_DELETE_OR_UPDATE)
def test_can_not_create_group(run_as, cli_confs, fixture_init, fixture_org1_owner_and_user, fixture_org2_owner_and_users, fixture_orphans):
...
@pytest.mark.parametrize("run_as", CAN_NOT_CREATE_DELETE_OR_UPDATE)
def test_can_not_associate_role_permission(run_as, cli_confs, fixture_init, fixture_org1_owner_and_user, fixture_org2_owner_and_users, fixture_orphans):
...
@pytest.mark.parametrize("run_as", CAN_NOT_CREATE_DELETE_OR_UPDATE)
def test_can_not_delete_group(run_as, cli_confs, fixture_init, fixture_org1_owner_and_user, fixture_org2_owner_and_users, fixture_orphans):
...
@pytest.mark.parametrize("run_as", CAN_NOT_CREATE_DELETE_OR_UPDATE)
def test_can_not_delete_permission(run_as, cli_confs, fixture_init, fixture_org1_owner_and_user, fixture_org2_owner_and_users, fixture_orphans):
...
@pytest.mark.parametrize("run_as", CAN_NOT_CREATE_DELETE_OR_UPDATE)
def test_can_not_delete_association(run_as, cli_confs, fixture_init, fixture_org1_owner_and_user, fixture_org2_owner_and_users, fixture_orphans):
...
def test_can_see_all_hits(cli_confs, fixture_init, fixture_org1_owner_and_user, fixture_org2_owner_and_users, fixture_collections):
...
def test_can_see_one_hit_with_permission(cli_confs, fixture_init, fixture_org1_owner_and_user, fixture_org2_owner_and_users, fixture_collections):
    """Test: as user with full visibility, I see all collection hits"""
    oid, email1, email2, groups = fixture_org1_owner_and_user
...
@pytest.mark.parametrize("run_as", CAN_NOT_CREATE_DELETE_OR_UPDATE)
def test_can_not_create_apikey(run_as, cli_confs, fixture_init, fixture_org1_owner_and_user, fixture_org2_owner_and_users, fixture_orphans):
    oid, email1, email2, groups = fixture_org1_owner_and_user
    if run_as != ANONYMOUS:  # arlas_cli does not handle calls to iam without identity
        with pytest.raises(SystemExit):
...
def test_can_not_create_apikey_for_other_org_users(cli_confs, fixture_init, fixture_org1_owner_and_user, fixture_org2_owner_and_users, fixture_orphans):
    oid, email1, email2, groups = fixture_org1_owner_and_user
...
def test_can_create_apikey_as_owner_and_admin(cli_confs, fixture_init, fixture_org1_owner_and_user, fixture_org2_owner_and_users, fixture_orphans):
    oid, email1, email2, groups = fixture_org1_owner_and_user
...
def test_can_delete_apikey_as_owner(cli_confs, fixture_init, fixture_org1_owner_and_user, fixture_org2_owner_and_users, fixture_orphans):
    oid, email1, email2, groups = fixture_org1_owner_and_user
...
@pytest.mark.parametrize("run_as", CAN_NOT_CREATE_DELETE_OR_UPDATE)
def test_can_not_delete_apikey(run_as, cli_confs, fixture_init, fixture_org1_owner_and_user, fixture_org2_owner_and_users, fixture_orphans):
    oid, email1, email2, groups = fixture_org1_owner_and_user
    id = Service.create_api_key(OWNER_ORG_1, oid, "API key for " + OWNER_ORG_1, 1, USER_TO_UID[OWNER_ORG_1], get_groups_and_roles_ids(oid)).get("id")
    if run_as != ANONYMOUS:  # arlas_cli does not handle calls to iam without identity
        with pytest.raises(SystemExit):
...
def test_apikey_works_no_group(cli_confs, fixture_init, fixture_org1_owner_and_user, fixture_org2_owner_and_users, fixture_collections):
    time.sleep(2)
    oid, email1, email2, groups = fixture_org1_owner_and_user
...
def test_apikey_works_with_groups(cli_confs, fixture_init, fixture_org1_owner_and_user, fixture_org2_owner_and_users, fixture_collections):
    oid, email1, email2, groups = fixture_org1_owner_and_user
...
@pytest.mark.parametrize("run_as", CAN_NOT_CREATE_DELETE_OR_UPDATE)
def test_can_not_authorize_org(run_as, cli_confs, fixture_init, fixture_org1_owner_and_user, fixture_org2_owner_and_users, fixture_orphans):
...
@pytest.mark.parametrize("run_as", CAN_NOT_CREATE_DELETE_OR_UPDATE)
def test_can_not_add_forbidden_org(run_as, cli_confs, fixture_init, fixture_org1_owner_and_user, fixture_org2_owner_and_users, fixture_orphans):
    if run_as != ANONYMOUS:  # arlas_cli does not handle calls to iam without identity
        with pytest.raises(SystemExit):
...
def test_can_forbid_org(cli_confs, fixture_init):
    assert Service.forbid_organisation(USER_ADMIN, "gisaia.com").get("name") == "gisaia.com"


def test_can_authorize_org(cli_confs, fixture_init):
    test_can_forbid_org(cli_confs, fixture_init)
    assert Service.authorize_organisation(USER_ADMIN, "gisaia.com").get("message") == "ok"


@pytest.mark.parametrize("run_as", CAN_NOT_CREATE_DELETE_OR_UPDATE)
def test_can_not_list_forbidden(run_as, cli_confs, fixture_init, fixture_org1_owner_and_user, fixture_org2_owner_and_users, fixture_orphans):
    assert Service.forbid_organisation(USER_ADMIN, "gisaia.com").get("name") == "gisaia.com"
    if run_as != ANONYMOUS:  # arlas_cli does not handle calls to iam without identity
        with pytest.raises(SystemExit):
...
def test_can_list_forbidden(cli_confs, fixture_init):
    assert Service.forbid_organisation(USER_ADMIN, "gisaia.com").get("name") == "gisaia.com"
