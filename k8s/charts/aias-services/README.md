...
| services.agate.image | string | `"gisaia/agate:0.12.0"` |  |
...
| services.airs.image | string | `"gisaia/airs:0.12.0"` |  |
...
| services.aproc.service.image | string | `"gisaia/aproc-service:0.12.0"` |  |
...
| services.aproc.worker.image | string | `"gisaia/aproc-proc:0.12.0"` |  |
...
| services.fam.image | string | `"gisaia/fam:0.12.0"` |  |
