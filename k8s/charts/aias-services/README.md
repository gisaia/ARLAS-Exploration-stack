...
![Version: 28.7.0](https://img.shields.io/badge/Version-28.7.0-informational?style=flat-square) ![AppVersion: 0.18.1](https://img.shields.io/badge/AppVersion-0.18.1-informational?style=flat-square)
...
| initBuckets | bool | `false` | Whether to initialize the S3 buckets used by AIRS service at startup or not |
...
| protocol | string | `"http"` | HTTP protocol used to access AIAS services |
...
| services.agate.configuration.roles.group/public | object | `{"description":["Public group"],"permissions":["r:session:DELETE","r:permissions:GET","r:organisations:GET,POST","r:organisations/check:GET","r:users/.*:GET,PUT,DELETE"]}` | Public role. See example at https://raw.githubusercontent.com/gisaia/ARLAS-server/master/arlas-commons/src/main/resources/roles.yaml |
| services.agate.configuration.roles.role/arlas/builder | object | `{"description":["Building dashboards in ARLAS"],"permissions":["r:collections:GET","r:collections/.*:PATCH,PUT,DELETE","r:collections/_export:GET","r:collections/_import:POST","r:persist/resource/.*:PUT,POST,DELETE"]}` | ARLAS Builder role |
| services.agate.configuration.roles.role/arlas/datasets | object | `{"description":["Managing data (ingest, update and enrich) in ARLAS"],"permissions":["r:datasets/.*:GET,PUT,POST,DELETE","r:/aproc/processes/ingest:GET","r:/aproc/processes/ingest/execution:POST","r:/aproc/processes/enrich:GET","r:/aproc/processes/enrich/execution:POST","r:/aproc/processes/directory_ingest:GET","r:/aproc/processes/directory_ingest/execution:POST","r:/aproc/processes/dc3build:GET","r:/aproc/processes/dc3build/execution:POST","r:/fam/.*:GET,POST","r:/aproc/jobs/.*:GET,DELETE","r:/aproc/jobs:GET","r:/airs/collections:GET","r:/airs/collections/.*:GET,POST,PUT,DELETE"]}` | ARLAS Datasets role |
| services.agate.configuration.roles.role/arlas/downloader | object | `{"description":["Download data from ARLAS"],"permissions":["r:/aproc/processes/download:GET","r:/aproc/processes/download/execution:POST","r:/aproc/jobs/.*:GET,DELETE"]}` | ARLAS Downloader role |
| services.agate.configuration.roles.role/arlas/owner | object | `{"description":["Managing users and permissions of ARLAS"],"permissions":["r:permissions:GET","r:collections:GET","r:organisations:GET,POST","r:organisations/.*:GET,POST,PUT,DELETE","r:users/.*:GET,PUT,DELETE","r:session:DELETE"]}` | ARLAS Owner role |
| services.agate.configuration.roles.role/arlas/tagger | object | `{"description":["Tagging data in ARLAS"],"permissions":["r:write/.*:POST","r:status/.*:GET"]}` | ARLAS Tagger role |
| services.agate.configuration.roles.role/arlas/user | object | `{"description":["Viewing data in ARLAS"],"permissions":["h:arlas-organization:${org}","h:arlas-workspace:${ws}","r:explore/.*:GET,POST","r:collections/.*:GET","r:explore/_list:GET","r:explore/ogc/opensearch/.*:GET","r:ogc/.*:GET","r:stac:GET","r:openapi.json:GET","r:stac/.*:GET,POST","r:persist/resource/.*:GET","r:persist/groups/.*:GET","r:persist/resources/.*:GET","r:authorize/resources:GET"]}` | ARLAS User role |
| services.agate.configuration.roles.role/iam/admin | object | `{"description":["IAM admin"],"permissions":["r:organisations:GET,POST","r:organisations/.*:GET,POST,DELETE","r:users/.*:GET,PUT,DELETE","r:session:DELETE","r:permissions:GET"]}` | IAM Admin role |
| services.agate.configuration.roles.role/m2m/importer.description[0] | string | `"M2M account for importing collections"` |  |
| services.agate.configuration.roles.role/m2m/importer.permissions[0] | string | `"r:collections:GET"` |  |
| services.agate.configuration.roles.role/m2m/importer.permissions[1] | string | `"r:collections/.*:PATCH,PUT,DELETE"` |  |
| services.agate.configuration.roles.role/m2m/importer.permissions[2] | string | `"r:collections/_import:POST"` |  |
| services.agate.configuration.roles.role/m2m/importer.permissions[3] | string | `"r:organisations/.*:GET"` |  |
| services.agate.configuration.roles.role/m2m/importer.permissions[4] | string | `"r:persist/resource/.*:POST,PUT"` |  |
...
| services.aproc.configuration.extensions.enrich.drivers.landsat_cog.enabled | bool | `true` |  |
| services.aproc.configuration.extensions.enrich.drivers.landsat_cog.priority | int | `2` |  |
| services.aproc.configuration.extensions.enrich.drivers.s2_cog.configuration.all_bands_cog_max_width_or_height | int | `10000` |  |
| services.aproc.configuration.extensions.enrich.drivers.s2_cog.configuration.cog_max_width_or_height | int | `-1` |  |
| services.aproc.configuration.extensions.enrich.drivers.s2_cog.configuration.cog_overview_max_width_or_height | int | `2000` |  |
...
| services.aproc.configuration.extensions.ingest.aprocEndpoint | string | `"http://aproc-service:8000"` | APROC endpoint URL accessed by the ingest extension |
| services.aproc.configuration.extensions.ingest.drivers.astDem.build_overview_when_local | bool | `true` |  |
| services.aproc.configuration.extensions.ingest.drivers.astDem.build_overview_when_remote | bool | `true` |  |
| services.aproc.configuration.extensions.ingest.drivers.astDem.enabled | bool | `true` |  |
| services.aproc.configuration.extensions.ingest.drivers.astDem.overview_stretch | bool | `true` |  |
...
| services.aproc.configuration.extensions.ingest.drivers.dimap.build_overview_when_local | bool | `true` |  |
| services.aproc.configuration.extensions.ingest.drivers.dimap.build_overview_when_remote | bool | `true` |  |
...
| services.aproc.configuration.extensions.ingest.drivers.iceye.build_overview_when_local | bool | `true` |  |
| services.aproc.configuration.extensions.ingest.drivers.iceye.build_overview_when_remote | bool | `true` |  |
...
| services.aproc.configuration.extensions.ingest.drivers.jpeg2000.build_overview_when_local | bool | `true` |  |
| services.aproc.configuration.extensions.ingest.drivers.jpeg2000.build_overview_when_remote | bool | `true` |  |
...
| services.aproc.configuration.extensions.ingest.drivers.landsat.build_overview_when_local | bool | `true` |  |
| services.aproc.configuration.extensions.ingest.drivers.landsat.build_overview_when_remote | bool | `true` |  |
| services.aproc.configuration.extensions.ingest.drivers.landsat.enabled | bool | `true` |  |
| services.aproc.configuration.extensions.ingest.drivers.landsat.priority | int | `19` |  |
| services.aproc.configuration.extensions.ingest.drivers.opencosmos.build_overview_when_local | bool | `true` |  |
| services.aproc.configuration.extensions.ingest.drivers.opencosmos.build_overview_when_remote | bool | `true` |  |
| services.aproc.configuration.extensions.ingest.drivers.opencosmos.enabled | bool | `true` |  |
| services.aproc.configuration.extensions.ingest.drivers.opencosmos.priority | int | `23` |  |
| services.aproc.configuration.extensions.ingest.drivers.opencosmos.product_types[0] | string | `"platero"` |  |
| services.aproc.configuration.extensions.ingest.drivers.opencosmos.product_types[1] | string | `"hammer"` |  |
| services.aproc.configuration.extensions.ingest.drivers.radarsat2.build_overview_when_local | bool | `true` |  |
| services.aproc.configuration.extensions.ingest.drivers.radarsat2.build_overview_when_remote | bool | `true` |  |
...
| services.aproc.configuration.extensions.ingest.drivers.rapideye.build_overview_when_local | bool | `true` |  |
| services.aproc.configuration.extensions.ingest.drivers.rapideye.build_overview_when_remote | bool | `true` |  |
...
| services.aproc.configuration.extensions.ingest.drivers.satellogic.build_overview_when_local | bool | `true` |  |
| services.aproc.configuration.extensions.ingest.drivers.satellogic.build_overview_when_remote | bool | `true` |  |
| services.aproc.configuration.extensions.ingest.drivers.satellogic.enabled | bool | `true` |  |
| services.aproc.configuration.extensions.ingest.drivers.satellogic.priority | int | `20` |  |
| services.aproc.configuration.extensions.ingest.drivers.sentinel1.build_overview_when_local | bool | `true` |  |
| services.aproc.configuration.extensions.ingest.drivers.sentinel1.build_overview_when_remote | bool | `true` |  |
...
| services.aproc.configuration.extensions.ingest.drivers.sentinel2.build_overview_when_local | bool | `true` |  |
| services.aproc.configuration.extensions.ingest.drivers.sentinel2.build_overview_when_remote | bool | `true` |  |
...
| services.aproc.configuration.extensions.ingest.drivers.skysat.build_overview_when_local | bool | `true` |  |
| services.aproc.configuration.extensions.ingest.drivers.skysat.build_overview_when_remote | bool | `true` |  |
...
| services.aproc.configuration.extensions.ingest.drivers.spot5.build_overview_when_local | bool | `true` |  |
| services.aproc.configuration.extensions.ingest.drivers.spot5.build_overview_when_remote | bool | `true` |  |
...
| services.aproc.configuration.extensions.ingest.drivers.terrasarx.build_overview_when_local | bool | `true` |  |
| services.aproc.configuration.extensions.ingest.drivers.terrasarx.build_overview_when_remote | bool | `true` |  |
...
| services.aproc.configuration.extensions.ingest.drivers.tiff.build_overview_when_local | bool | `true` |  |
| services.aproc.configuration.extensions.ingest.drivers.tiff.build_overview_when_remote | bool | `true` |  |
...
| services.aproc.configuration.extensions.ingest.drivers.umbra.build_overview_when_local | bool | `true` |  |
| services.aproc.configuration.extensions.ingest.drivers.umbra.build_overview_when_remote | bool | `true` |  |
...
| services.aproc.configuration.extensions.ingest.drivers.wyvern.build_overview_when_local | bool | `true` |  |
| services.aproc.configuration.extensions.ingest.drivers.wyvern.build_overview_when_remote | bool | `true` |  |
...
| services.aproc.configuration.extensions.ingest.enrichments[0] | string | `"OVERVIEW_COG"` |  |
