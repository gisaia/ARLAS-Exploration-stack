...
![Version: 27.55.0](https://img.shields.io/badge/Version-27.55.0-informational?style=flat-square) ![AppVersion: 0.12.2](https://img.shields.io/badge/AppVersion-0.12.2-informational?style=flat-square)
...
| services.agate.image | string | `"gisaia/agate:0.12.2"` |  |
...
| services.airs.image | string | `"gisaia/airs:0.12.2"` |  |
...
| services.aproc.service.image | string | `"gisaia/aproc-service:0.12.2"` |  |
...
| services.aproc.worker.image | string | `"gisaia/aproc-proc:0.12.2"` |  |
...
| services.fam.image | string | `"gisaia/fam:0.12.2"` |  |
