...
| services.permissions.image | string | `"gisaia/arlas-permissions-server:27.1.2"` |  |
...
| services.persistence.image | string | `"gisaia/arlas-persistence-server:27.1.1"` |  |
...
| services.server.image | string | `"gisaia/arlas-server:27.3.3"` |  |
