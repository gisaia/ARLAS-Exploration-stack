...
![Version: 27.72.0](https://img.shields.io/badge/Version-27.72.0-informational?style=flat-square) ![AppVersion: 27.1.6](https://img.shields.io/badge/AppVersion-27.1.6-informational?style=flat-square)
...
| uis.builder.image | string | `"gisaia/arlas-wui-builder:27.2.0-rc.1"` |  |
...
| uis.hub.image | string | `"gisaia/arlas-wui-hub:27.2.0-rc.1"` |  |
...
| uis.wui.image | string | `"gisaia/arlas-wui:27.2.0-rc.1"` |  |
