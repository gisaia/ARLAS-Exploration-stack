...
curl https://raw.githubusercontent.com/gisaia/ARLAS-EO/v1.3.0/mapping.json -o arlas_eo_mapping.json
curl https://raw.githubusercontent.com/gisaia/ARLAS-EO/v1.3.0/downloads_mapping.json -o arlas_eo_download_mapping.json
