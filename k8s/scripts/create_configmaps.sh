...
curl https://raw.githubusercontent.com/gisaia/ARLAS-EO/v0.0.9/mapping.json -o arlas_eo_mapping.json
curl https://raw.githubusercontent.com/gisaia/ARLAS-EO/v0.0.9/downloads_mapping.json -o arlas_eo_download_mapping.json
