...
- [arlas-wui](https://github.com/gisaia/ARLAS-wui) version >= 14.1.0
- [arlas-hub](https://github.com/gisaia/ARLAS-wui-hub) version >= 14.1.0
- [arlas-builder](https://github.com/gisaia/ARLAS-wui-builder) version >= 14.1.0
...
############################################
ARLAS WUI in version 14.1.0 is running on http://localhost:81/wui
ARLAS HUB in  version 14.1.0 is running on http://localhost:81/hub
ARLAS BUILDER  in version 14.1.0 is running on http://localhost:81/builder
############################################
