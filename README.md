...
- [arlas-wui](https://github.com/gisaia/ARLAS-wui) version >= 20.0.0
- [arlas-hub](https://github.com/gisaia/ARLAS-wui-hub) version >= 20.0.0
- [arlas-builder](https://github.com/gisaia/ARLAS-wui-builder) version >= 20.0.0
- [arlas-persistence-server](https://github.com/gisaia/ARLAS-persistence) version >= 20.0.0
- [arlas-permissions-server](https://github.com/gisaia/ARLAS-permissions) version >= 20.0.0
- [elasticsearch](https://github.com/elastic/elasticsearch) version >= 7.9.2
- [arlas-server](https://github.com/gisaia/ARLAS-server) version >= 20.7.0
...
############################################
ARLAS WUI in version 20.0.0 is running on http://localhost:81/wui
ARLAS HUB in  version 20.0.0 is running on http://localhost:81/hub
ARLAS BUILDER  in version 20.0.0 is running on http://localhost:81/builder
############################################
                                            
############################################
ARLAS PERSISTENCE SERVER in version 20.0.0 is running on http://localhost:81/persist/
ARLAS PERMISSIONS SERVER in version 20.0.0 is running on http://localhost:81/permissions/
ARLAS SERVER in version 20.7.0 is running on http://localhost:81/server/
############################################
