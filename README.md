...
- [arlas-wui](https://github.com/gisaia/ARLAS-wui) version >= 16.1.2
- [arlas-hub](https://github.com/gisaia/ARLAS-wui-hub) version >= 16.1.0
- [arlas-builder](https://github.com/gisaia/ARLAS-wui-builder) version >= 16.1.3
...
############################################
ARLAS WUI in version 16.1.2 is running on http://localhost:81/wui
ARLAS HUB in  version 16.1.0 is running on http://localhost:81/hub
ARLAS BUILDER  in version 16.1.3 is running on http://localhost:81/builder
############################################
