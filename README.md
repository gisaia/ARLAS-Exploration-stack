...
- [arlas-wui](https://github.com/gisaia/ARLAS-wui) version >= 17.1.1
...
- [arlas-server](https://github.com/gisaia/ARLAS-server) version >= 17.7.0
...
############################################
ARLAS WUI in version 17.1.1 is running on http://localhost:81/wui
...
############################################
ARLAS PERSISTENCE SERVER in version 17.0.0 is running on http://localhost:81/persist/
ARLAS PERMISSIONS SERVER in version 17.0.0 is running on http://localhost:81/permissions/
ARLAS SERVER in version 17.7.0 is running on http://localhost:81/server/
############################################
