...
- [arlas-wui](https://github.com/gisaia/ARLAS-wui) version >= 15.0.2
- [arlas-hub](https://github.com/gisaia/ARLAS-wui-hub) version >= 15.0.0
- [arlas-builder](https://github.com/gisaia/ARLAS-wui-builder) version >= 15.0.2
...
############################################
ARLAS WUI in version 15.0.2 is running on http://localhost:81/wui
ARLAS HUB in  version 15.0.0 is running on http://localhost:81/hub
ARLAS BUILDER  in version 15.0.2 is running on http://localhost:81/builder
############################################
