...
| arlas-uis | object | `{"basemap":{"storageSize":"50Mi"},"logger":{"loggingConsoleLevel":"INFO","loggingLevel":"INFO"},"uis":{"arlas":{"bg":"#B0BC97"},"builder":{"extraEnvVars":null},"famWui":{"extraEnvVars":null},"handle":{"color":"#76880e"},"hub":{"extraEnvVars":null},"wui":{"extraEnvVars":null}}}` | See the documentation of the sub-chart arlas-uis https://docs.arlas.io/external_docs/ARLAS-Exploration-stack/helm/arlas-uis/ |
