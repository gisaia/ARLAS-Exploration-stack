...
| arlas-uis | object | `{"basemap":{"storageSize":"50Mi"},"logger":{"loggingConsoleLevel":"INFO","loggingLevel":"INFO"},"uis":{"builder":{"extraEnvVars":null},"colors":{"arlas":{"bg":"#182e6f"},"handle":{"color":"#182e6f"}},"famWui":{"extraEnvVars":null},"hub":{"extraEnvVars":null},"wui":{"basemapUrl":null,"extraEnvVars":null}}}` | See the documentation of the sub-chart arlas-uis https://docs.arlas.io/external_docs/ARLAS-Exploration-stack/helm/arlas-uis/ |
...
| arlas-uis.uis.wui.basemapUrl | string | `nil` | Extra environment variables for the basemap url to download at init container startup (no download if already present). If none specified, a small basemap is used. See for instance https://build.protomaps.com/20231225.pmtiles for a full basemap. |
