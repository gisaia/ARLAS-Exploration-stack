...
![Version: 28.9.0](https://img.shields.io/badge/Version-28.9.0-informational?style=flat-square) ![AppVersion: 28.0.3](https://img.shields.io/badge/AppVersion-28.0.3-informational?style=flat-square)
...
| uis.famWui.image | string | `"gisaia/arlas-fam-wui:0.19.0"` |  |
