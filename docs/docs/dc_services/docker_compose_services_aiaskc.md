...
Image: `ARLAS_SERVER_VERSION` with `gisaia/arlas-server:28.0.0-rc3` in `conf/versions.env`
...
Image: `ARLAS_PERSISTENCE_VERSION` with `gisaia/arlas-persistence-server:28.0.0-rc3` in `conf/versions.env`
...
Image: `ARLAS_PERMISSIONS_VERSION` with `gisaia/arlas-permissions-server:28.0.0-rc3` in `conf/versions.env`
...
Image: `ARLAS_BUILDER_VERSION` with `gisaia/arlas-wui-builder:28.0.0-rc.3` in `conf/versions.env`
...
Image: `ARLAS_HUB_VERSION` with `gisaia/arlas-wui-hub:28.0.0-rc.3` in `conf/versions.env`
...
Image: `ARLAS_WUI_VERSION` with `gisaia/arlas-wui:28.0.0-rc.3` in `conf/versions.env`
...
Image: `ARLAS_VERSION_AIRS` with `gisaia/airs:0.15.2` in `conf/versions.env`
...
Image: `ARLAS_VERSION_APROC_PROC` with `gisaia/aproc-proc:0.15.2` in `conf/versions.env`
...
| `ARLAS_SMTP_USERNAME` | `ARLAS_SMTP_USERNAME` | `` |  | `tobechanged` in `conf/aias.env` |
| `ARLAS_SMTP_PASSWORD` | `ARLAS_SMTP_PASSWORD` | `` |  | `tobechanged` in `conf/aias.env` |
| `ARLAS_SMTP_FROM` | `ARLAS_SMTP_FROM` | `` |  | `tobechanged@tobechanged.io` in `conf/aias.env` |
...
Image: `ARLAS_VERSION_APROC_SERVICE` with `gisaia/aproc-service:0.15.2` in `conf/versions.env`
...
Image: `ARLAS_VERSION_FAM_WUI` with `gisaia/arlas-fam-wui:0.15.2` in `conf/versions.env`
...
Image: `ARLAS_VERSION_FAM` with `gisaia/fam:0.15.2` in `conf/versions.env`
...
Image: `ARLAS_VERSION_AGATE` with `gisaia/agate:0.15.2` in `conf/versions.env`
...
| `VERIFY_JWT` | `VERIFY_JWT` | `true` |  | `true` in `conf/arlas_keycloak.env` |
| `VERIFY_SSL` | `VERIFY_SSL` | `true` |  | `false` in `conf/arlas_keycloak.env` |
| `JWKS_URI` | `JWKS_URI` | `` |   | `https://${ARLAS_HOST}:9443/auth/realms/arlas/proto ...` in `conf/arlas_keycloak.env` |
