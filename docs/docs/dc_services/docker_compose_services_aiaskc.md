...
Image: `ARLAS_SERVER_VERSION` with `gisaia/arlas-server:27.3.3` in `conf/versions.env`
...
Image: `ARLAS_PERSISTENCE_VERSION` with `gisaia/arlas-persistence-server:27.1.1` in `conf/versions.env`
...
Image: `ARLAS_PERMISSIONS_VERSION` with `gisaia/arlas-permissions-server:27.1.2` in `conf/versions.env`
...
Image: `ARLAS_VERSION_AIRS` with `gisaia/airs:0.15.1` in `conf/versions.env`
...
Image: `ARLAS_VERSION_APROC_PROC` with `gisaia/aproc-proc:0.15.1` in `conf/versions.env`
...
Image: `ARLAS_VERSION_APROC_SERVICE` with `gisaia/aproc-service:0.15.1` in `conf/versions.env`
...
Image: `ARLAS_VERSION_FAM_WUI` with `gisaia/arlas-fam-wui:0.15.1` in `conf/versions.env`
...
Image: `ARLAS_VERSION_FAM` with `gisaia/fam:0.15.1` in `conf/versions.env`
...
Image: `ARLAS_VERSION_AGATE` with `gisaia/agate:0.15.1` in `conf/versions.env`
