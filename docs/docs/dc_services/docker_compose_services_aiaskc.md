...
Image: `ARLAS_VERSION_AIRS` with `gisaia/airs0.7.7` in `conf/versions.env`
...
Image: `ARLAS_VERSION_APROC_PROC` with `gisaia/aproc-proc0.7.7` in `conf/versions.env`
...
Image: `ARLAS_VERSION_APROC_SERVICE` with `gisaia/aproc-service0.7.7` in `conf/versions.env`
...
Image: `ARLAS_VERSION_FAM_WUI` with `gisaia/arlas-fam-wui0.7.7` in `conf/versions.env`
...
Image: `ARLAS_VERSION_FAM` with `gisaia/fam0.7.7` in `conf/versions.env`
...
Image: `ARLAS_VERSION_AGATE` with `gisaia/agate0.7.7` in `conf/versions.env`
