...
Image: `ARLAS_WUI_VERSION` with `gisaia/arlas-wui:28.0.2` in `conf/versions.env`
...
Image: `ARLAS_VERSION_AIRS` with `gisaia/airs:0.15.7` in `conf/versions.env`
...
Image: `ARLAS_VERSION_APROC_PROC` with `gisaia/aproc-proc:0.15.7` in `conf/versions.env`
...
Image: `ARLAS_VERSION_APROC_SERVICE` with `gisaia/aproc-service:0.15.7` in `conf/versions.env`
...
Image: `ARLAS_VERSION_FAM_WUI` with `gisaia/arlas-fam-wui:0.15.7` in `conf/versions.env`
...
Image: `ARLAS_VERSION_FAM` with `gisaia/fam:0.15.7` in `conf/versions.env`
...
Image: `ARLAS_VERSION_AGATE` with `gisaia/agate:0.15.7` in `conf/versions.env`
